...
/**
 * Class method The InterfaceView class creates the GUI of the Fitbit program It
 * also implements page navigation between the different screens
 */
public class InterfaceView {
	...
	/**
	 * Method to set JLabel values for minutes & resting heart rate For now,
	 * zones will be left out (hardcoded in currently)
	 * 
	 * @param minutes
	 * @param rate
	 */
