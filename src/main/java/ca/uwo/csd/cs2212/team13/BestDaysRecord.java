...
public class BestDaysRecord implements Serializable{
	 ...
	 * with arguments from activities.json.
	 * 
	 * @param dis_date
	 *            date of best day for distance from the JSON file
	 * @param dis_value
	 *            value for distance on the best recorded day day from the JSON
	 *            file
	 * @param floors_date
	 *            date of best day for floors from the JSON file
	 * @param floors_value
	 *            value for floors on the best recorded day day from the JSON
	 *            file
	 * @param steps_date
	 *            date of best day for steps from the JSON file
	 * @param steps_value
	 *            value for steps on the best recorded day day from the JSON
	 *            file
	 */
	public BestDaysRecord(String dis_date, double dis_value,
			String floors_date, int floors_value, String steps_date,
			int steps_value) {
		super();
	 ...
	 * 
	 * @return dis_date date for the day on which the farthest distance was
	 *         traveled
	 */
	 ...
	 * 
	 * @param dis_value
	 *            the new value for distance traveled on the best day.
	 */
	 ...
	 * 
	 * @return floors_date date for the day on which the most floors were
	 *         climbed
	 */
	 ...
	 * 
	 * @param floors_value
	 *            the new value for floors climbed on the best day.
	 */
	 ...
	 * 
	 * @param steps_value
	 *            the new value for steps taken on the best day.
	 */
