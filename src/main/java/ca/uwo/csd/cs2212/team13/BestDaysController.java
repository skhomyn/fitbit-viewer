...
/**
 * Java Object which passes information from the the <code>BestDaysRecord</code>
 * object to the <code>InterfaceView</code> object.
 * <p>
 * <code>BestDaysController</code> contains references to the model object
 * {@link BestDaysRecord}, which contains the data for the Best Days page, and
 ...
 * <code>BestDaysRecord</code> to the view <code>InterfaceView</code>, so that
 * it can be displayed to the user.
 */
public class BestDaysController {

	/**
	 * Best days record for controller
	 */
	private BestDaysRecord model;

	/**
	 * Interface view for controller
	 */
	 ...
	 * {@link InterfaceView#addClickListenerBestDays(ActionListener)} to add a
	 * click listener to the Best Days button.
	 * 
	 * @param model
	 ...
	 * the Best Days button in <code>InterfaceView</code> is clicked by the user
	 *
	 * @see java.awt.event.ActionListener
	 */
	class clickListener implements ActionListener {
		/**
		 * Sets the Best Days page display fields in <code>InterfaceView</code>
		 * with values from the appropriate model <code>BestDaysRecord</code>
