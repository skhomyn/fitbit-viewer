...
public class AppRefreshTokens {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// new
			// FileReader("/Users/BethLocke/Dropbox/CS2212B_2016/Workspace/FitbitTest/src/main/resources/BethCredentials.txt");
			new FileReader("src/main/resources/Team13Credentials.txt");
		...
		requestUrl = requestUrlPrefix
				+ "activities/floors/date/2016-01-07/1d/1min/time/19:15/19:30.json";
		...
		try {
			...
			fileWriter =
			// new
			// FileWriter("/Users/BethLocke/Dropbox/CS2212B_2016/Workspace/FitbitTest/src/main/resources/BethTokens.txt");
			new FileWriter("src/main/resources/Team13Tokens.txt");
